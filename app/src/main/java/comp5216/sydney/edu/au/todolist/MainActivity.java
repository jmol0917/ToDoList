...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEditAdd = findViewById(R.id.btnAddEdit);
        setUpEditAddBtn();
    ...
    public void setUpEditAddBtn(){
        btnEditAdd.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view){
                int itemsLength = items.size();
                Intent intent = new Intent(MainActivity.this, EditToDoItemActivity.class);
                    if (intent != null) {
                        intent.putExtra("position", itemsLength);
                        ...
                        .setPositiveButton(R.string.delete, new
                                DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        itemsAdapter.notifyDataSetChanged(); // Notify listView adapt to update the list
                                        //saveItemsToFile();
                                        saveItemsToDatabase();
                                    }
                                })
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == EDIT_ITEM_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                String editedItem = data.getExtras().getString("item")  + " " + getDateTime();
            ...
            else if (resultCode == RESULT_CANCELED && data.getExtras().getString("item").equals("")){
